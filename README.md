...
- MECÁNICA FASES-RONDAS: <br>- 3 fases en total <br>-Fase 1: consta de 8 rondas. En cada ronda aparece un animal nuevo (en la ronda 1 aparece 1 animal; en la ronda 8 aparecen 8 animales). El intervalo de tiempo entre cada aparición es el mismo en cada ronda: 1000 milisegundos. <br>-Fase 2: igual que fase 1, excepto en los intervalos de tiempo entre apariciones. Intervalos de tiempo: <ul><li>Ronda 1 y 2: 1000 milisegundos</li><li>Ronda 3 y 4: 850 milisegundos</li><li>Ronda 5 y 6: 800 milisegundos</li><li>Ronda 7 y 8: 750 milisegundos</li></ul> -Fase 3: 
